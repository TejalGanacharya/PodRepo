...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of KImageCropper.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/tejal.ganacharya@lnttechservices.com/KImageCropper'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'tejal.ganacharya@lnttechservices.com' => 'sagar.bheda@lnttechservices.com' }
  s.source           = { :git => 'https://github.com/tejal.ganacharya@lnttechservices.com/KImageCropper.git', :tag => s.version.to_s }
